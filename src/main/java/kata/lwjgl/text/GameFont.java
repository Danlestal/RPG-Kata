...
public class GameFont {
     ...
     */
    public GameFont(boolean antiAlias) {
     ...
     * @param antiAlias Wheter the font should be antialiased or not
     */
    public GameFont(int size, boolean antiAlias) {
     ...
     */
    public GameFont(InputStream in, int size) throws FontFormatException, IOException {
        this(in, size, true);
    }
     ...
     * @throws IOException         If font can't be read
     */
    public GameFont(InputStream in, int size, boolean antiAlias) throws FontFormatException, IOException {
     ...
     */
    public GameFont(java.awt.Font font) {
        this(font, true);
    }
     ...
     * @param antiAlias Wheter the font should be antialiased or not
     */
    public GameFont(java.awt.Font font, boolean antiAlias) {
        glyphs = new HashMap<>();
